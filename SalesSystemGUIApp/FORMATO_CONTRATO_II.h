...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(489, 566);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(73, 28);
			this->button1->TabIndex = 60;
			this->button1->Text = L"Cerrar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &FORMATO_CONTRATO_II::button1_Click);
			// 
			// label21
			// 
...
#pragma endregion
		...
		void FORMATO_CONTRATO_II::CerrarFormatoContratoII(System::Object^ sender, FormClosedEventArgs^ e)
		{
			this->Show();
		}
...
private: System::Void button1_Click_1(System::Object^ sender, System::EventArgs^ e) {
	...
	fORMATO_CONTRATO_II->FormClosed += gcnew FormClosedEventHandler(this, &FORMATO_CONTRATO_II::CerrarFormatoContratoII);
...
private: System::Void FORMATO_CONTRATO_II_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	if (departamentoEncontrado != nullptr && inquilinoEncontrado != nullptr) {
		...
		txtNombreArrendatario->Text = nombre + " " + apellido + "\r\nARRENDATARIO";
	}
}
};
}
